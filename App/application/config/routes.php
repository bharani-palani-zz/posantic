...
$route['find_store'] = "default/user/find_store";
$route['signup'] = "default/user/signup";
$route['startup'] = "default/user/startup_page";
$route['signup_form'] = "default/user/signup_form";
$route['terms'] = "default/user/terms";
$route['checkdomain'] = "default/user/checkdomain";

$route['signin'] = "login/affirm";
$route['logout'] = "login/affirm/logout";
$route['welcome'] = "default/user/welcome";
...
$route['inventory/stock_take'] = "inventory/inventory/stock_take_list";
$route['inventory/insert_stock_take'] = "inventory/inventory/insert_stock_take";
...
$route['inventory/stock_take/show/id/(:any)'] = "inventory/inventory/show_stock_take/$1";
$route['inventory/stock_take/finalise/id/(:any)'] = "inventory/inventory/finalise/$1";
$route['inventory/stock_take/delete/id/(:any)'] = "inventory/inventory/stock_take_delete/$1";
$route['inventory/stock_take/complete/id/(:any)'] = "inventory/inventory/stock_take_complete/$1";
$route['inventory/stock_take/csv_export/(:any)'] = "inventory/inventory/export_stocktake_csv/$1";
...
$route['api/1.0/stocktake_products/(:any)'] = "inventory/inventory_json/get_ST_products/$1";
$route['api/1.0/stocktakes'] = "inventory/inventory_json/get_ST_id_main_data";
$route['api/1.0/stocktake_sub_products'] = "inventory/inventory_json/get_ST_id_sub_data";
$route['api/1.0/stocktake_counted_products/(:any)'] = "inventory/inventory_json/get_ST_id_products/$1";
$route['api/1.0/stocktake_post_products'] = "inventory/inventory_json/post_ST_products";
$route['api/1.0/stocktake_post_product_count'] = "inventory/inventory_json/post_ST_product_count";


/*

Alert if u are updating codeigniter to further version.
The effects are,
1. The update_batch function bug is manually fixed in db_active_record.php. Check for bug fixed if you are updating.
But in version >= 2.2.4 it is fixed.
2. Implode (", ") is fixed to Implode (",") in db_active_record.php on line 1706. Check for bug fixed if you are updating. 
This is manually fixed in system_ci_2.2.3 and system_ci_2.2.4 since this bug is not fixed yet.
If this is not handled yet, your csv export product variant fields 1,2,3 fields will not work correct.
