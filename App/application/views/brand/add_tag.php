...
<?php 
echo form_open(base_url().'tag/insert_tag',array('id' => 'form_add_tag'));
?>
...
<div class="modal-body">
    <div class="input-group">
        <label for="tag_name" class="input-group-addon">
      	...
      	<?php echo form_input(array('autocomplete' => 'off', 'name' => 'tag_name', 'class' => 'form-control', 'id' => 'tag_name','placeholder' => 'Max 25 Characters')) ?>
    </div>
...
<div class="modal-footer">
    <button type="submit" name="add_brand" class="btn btn-success"><i class="fa fa-save fa-fw"></i>Save</button>
